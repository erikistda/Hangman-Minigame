...
themen_woerter = {
    ...
    "Städte": ["AMSTERDAM", "BARCELONA", "BEIJING", "BERLIN", "BANGKOK", "BUDAPEST", "BUENOSAIRES", "CAPE TOWN", "CHICAGO", "COPENHAGEN", "DUBLIN", "DUBAI", "EDINBURGH", "FRANKFURT", "GENEVA", "HAMBURG", "HELSINKI", "HONGKONG", "ISTANBUL", "JAKARTA", "KUALALUMPUR", "KYOTO", "LISBON", "LONDON", "LOSANGELES", "MADRID", "MANILA", "MELBOURNE", "MEXICOCITY", "MIAMI", "MILAN", "MOSCOW", "MUNICH", "NAIROBI", "NEWDELHI", "NEWYORK", "OSLO", "PARIS", "PRAGUE", "RIODEJANEIRO", "ROME", "SANFRANCISCO", "SANTIAGO", "SÃO PAULO", "SEOUL", "SHANGHAI", "SINGAPORE", "STOCKHOLM", "SYDNEY", "TAIPEI", "TOKYO", "TORONTO", "VALENCIA", "VANCOUVER", "VENICE", "VIENNA", "WARSAW", "WASHINGTON", "ZÜRICH", "BERN"],
    ...
    "Games": ["MINECRAFT", "FORTNITE", "ROBLOX", "AMONG US", "CALL OF DUTY", "BATTLEFIELD", "HALO", "OVERWATCH", "VALORANT", "LEAGUE OF LEGENDS", "WORLD OF WARCRAFT", "COUNTER-STRIKE", "APEX LEGENDS", "PUBG", "GRAND THEFT AUTO", "RED DEAD REDEMPTION", "ASSASSINS CREED", "FAR CRY", "SKYRIM", "FALLOUT", "THE WITCHER", "CYBERPUNK", "ELDEN RING", "DARK SOULS", "SEKIRO", "HORIZON", "GOD OF WAR", "UNCHARTED", "THE LAST OF US", "SPIDER-MAN", "BATMAN ARKHAM", "RESIDENT EVIL", "DEAD RISING", "DEATH STRANDING", "PORTAL", "HALF-LIFE", "TERRARIA", "STARDEW VALLEY", "ANIMAL CROSSING", "POKEMON", "THE LEGEND OF ZELDA", "MARIO KART", "SUPER MARIO", "SUPER SMASH BROS", "METROID", "DONKEY KONG", "FIFA", "NBAK", "ROCKET LEAGUE", "SIMS", "CIVILIZATION", "TEKKEN", "STREET FIGHTER", "MORTAL KOMBAT", "RAINBOW SIX", "PAYDAY", "LEFT 4 DEAD", "DOTA", "TEAM FORTRESS", "PALWORLD", "HOGWARTS LEGACY", "BALDURS GATE", "FORZA HORIZON", "GRAN TURISMO", "TOMB RAIDER", "CONTROL", "ALAN WAKE", "DEAD ISLAND", "SUBNAUTICA", "OUTLAST", "LITTLE BIG PLANET", "GHOST OF TSUSHIMA", "GHOST OF YOTEI", "KIRBY", ],
